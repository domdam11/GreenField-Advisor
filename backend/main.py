...
from backend.controllers.interventionsController import ensure_interventions_indexes
from backend.routers import interventionsRouter
from backend.routers import trefleRouter
from backend.routers import weatherRouter


uploads_dir = Path(settings.UPLOAD_DIR)
uploads_dir.mkdir(parents=True, exist_ok=True)

from backend.routers import userRouter, plantsRouter
